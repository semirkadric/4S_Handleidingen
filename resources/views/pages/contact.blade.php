...
.container-contact .inner .panel.panel-left {
  margin-left: -10%;
}

.container-contact .inner .panel .panel-content {
  position: absolute;
  width: 100%;
  height: 100%;
  left: 50%;
...
.container-contact .inner .panel.panel-left .panel-content .image-background {
  position: absolute;
  width: 100%;
  height: 100%;
  left: 50%;
...
.container-contact .inner .panel.panel-right {
  margin-right: -10%;
  background:#343a40;
}

.container-contact .inner .panel.panel-right .panel-content .form {
  display: block;
  position: absolute;
  margin: 0 auto;
  width: 300px;
...
.container-contact .inner .panel.panel-right .panel-content .form h1 {
  display: block;
  margin: 0 0 45px 0;
  color: #B1B1B1;
  font-weight: 200;
